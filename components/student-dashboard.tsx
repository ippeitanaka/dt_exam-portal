                      ...
                      <div className="text-center">
                        ...
                        <div className="flex flex-col items-center justify-center mt-1 gap-3">
                          <div className="flex items-center justify-center gap-2">
                            <DentalMascot width={24} height={24} type="default" />
          ...
          <Card className="card-decorated">
            ...
            <CardContent>
              ...
              <div className="flex justify-center mt-8 gap-4">
                <DentalMascot width={50} height={50} type="default" />
                <DentalMascot width={50} height={50} type="large" />
                <DentalMascot width={50} height={50} type="small" />
              </div>
            </CardContent>
          </Card>
        </motion.div>
